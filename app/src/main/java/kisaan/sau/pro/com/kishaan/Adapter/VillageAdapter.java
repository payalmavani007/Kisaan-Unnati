...
public class VillageAdapter extends RecyclerView.Adapter<kisaan.sau.pro.com.kishaan.Adapter.VillageAdapter.DistDataViewHolder>  {
     ...
     */
        ...
        public VillageAdapter(Context mCtx, JSONArray array,FragmentManager fragmentManager)
        {
            this.mCtx = mCtx;
            this.array = array;
        ...
        @Override
        public kisaan.sau.pro.com.kishaan.Adapter.VillageAdapter.DistDataViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(mCtx);
            View view = inflater.inflate(R.layout.district_row, parent, false);
            return new kisaan.sau.pro.com.kishaan.Adapter.VillageAdapter.DistDataViewHolder(view);
        }

        @Override
        public void onBindViewHolder(final kisaan.sau.pro.com.kishaan.Adapter.VillageAdapter.DistDataViewHolder holder, final int position) {
            ...
            try {
                ...
                holder.item_layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        EmployeeProfileFragment fragment = null;
                        try {
                            fragment = new EmployeeProfileFragment(obj.getInt("id"));

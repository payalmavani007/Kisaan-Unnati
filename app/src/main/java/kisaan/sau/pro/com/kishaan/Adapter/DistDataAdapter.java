...
public class DistDataAdapter extends RecyclerView.Adapter<DistDataAdapter.DistDataViewHolder> {
    ...
    public DistDataAdapter(Context mCtx, JSONArray array,FragmentManager fragmentManager) {
        this.mCtx = mCtx;
        this.array = array;
...
//        Data data = dataList.get(position);
        ...
        try {
            ...
            holder.textname.setText(obj.getString("taluka_name"));
            ...
            holder.item_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        ...
                        TalukaProfileFragment fragment = new TalukaProfileFragment();
                        final Bundle bundle = new Bundle();
                        bundle.putString("taluka_name", holder.textname.getText().toString());
                        fragment.setArguments(bundle);

                        editor.putString("talukas_id",obj.getString("id")).apply();
                        FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                        fragmentTransaction.addToBackStack("District admin");
